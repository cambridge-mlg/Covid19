...
@model model_v1(
    ...
    daily_cases_pred = fill(TV(undef, num_total_days), num_countries)
    cases_pred = fill(TV(undef, num_total_days), num_countries)
    expected_daily_deaths = fill(TV(undef, num_total_days), num_countries)
    Rₜ = fill(TV(undef, num_total_days), num_countries)
